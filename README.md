...
The repo you download contains some sample images in `graphs/`. Some of these are from an old version of `monitorGrowth.py` that did not record the sum energy curve; new graphs will have both a population and energy curve.
